...
public class Ship {
    ...
    public String receiveStatForPort(){
        ...
        return "NAME: " + name + " DATE: " + time + " WAITING TIME: " +  getTimeInString(waitingTime)
                + " UNLOAD STARTED AT: " + getTimeInString(dateTime + waitingTime) + " AND LASTS: "
                + trueUnloadingTimeString + " CARGO " + cargoType;
    }
}
